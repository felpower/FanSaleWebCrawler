...
if __name__ == '__main__':
    url = 'https://www.fansale.at/fansale/tickets/show/masters-of-dirt/502095/16149179'
    ...
    for i in range(len(element)):
        ...
        print(
            "Count: " + counter_list[i] + " Price: " + element[i].text + " Price per Ticket: %.2f" % price_pre_ticket)
